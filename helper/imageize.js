...
// async function uploadFile(image, path, filename, size) {

//     console.log("image from helper ...............", image.path);
...
//     let uploaded = bucket.upload(path, {
//         public: true,
...
// async function uploadImage(image, size) {
//     let imageData = {};
...
//                 let awsImg = (await uploadFile(image, image.path, image.filename, "originalSize"))
...
//                 let awsImg = (await uploadFile(await uploadReduceFile(image), image.path, image.filename, "reduceSize"))
...
//                 let awsImg = (await uploadFile(await mediumImg(image), image.path, image.filename, "mediumSize"))
...
//             }
//             case 4: {
//                 let awsImg = (await uploadFile(await smallImg(image), image.path, image.filename, "smallSize"))
